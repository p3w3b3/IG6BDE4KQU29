...
if ("https://www.portal.peckwaterbrands.com/dashboard#contact" === currentPath2) {
$("#homebox").hide()
$(".ob-box").hide()
$("#obsidebar").hide()
$("#contactbox").show()
...
"https://www.portal.peckwaterbrands.com/dashboard#onboarding" === currentPath2
) {
$("#homebox").hide()
$(".ob-box").hide()
$("#ob1").show()
...
"https://www.portal.peckwaterbrands.com/dashboard#onboarding1" === currentPath2
) {
$("#homebox").hide();
$(".ob-box").hide();
$("#obsidebar").show();
...
"https://www.portal.peckwaterbrands.com/dashboard#onboarding2" === currentPath2
) {
$("#homebox").hide();
$(".ob-box").hide();
$("#ob2").show();
...
"https://www.portal.peckwaterbrands.com/dashboard#tracking" === currentPath2
) {
$("#homebox").hide();
$(".ob-box").hide();
$("#obsidebar").hide();
