      ...
      if (user) {
        ...
        let prereq = data['prereq'];
          ...
          let firstletter = name.substring(0, 1)
           ...
           let pizza1 = data['pizza3p1'];    
           let pizza2 = data['pizza3p2'];    
           let pizza3 = data['pizza3p3'];    
           let pizza4 = data['pizza3p4'];    
           let pizza5 = data['pizza3p5'];    
           let pizza6 = data['pizza3p6'];    
...
let course23 = data['pizzacourse3']
  ...
  firebase.firestore().doc("users/"+firebase.auth().currentUser.uid)
    .set({pizzacourse3total:spn}, {merge:true})
  }
  ...
  checkprog()
     ...
     if(!!name) {
      ...
      {
      setTimeout(() => { 
             window.location.href = '/dashboard/training/ruya-isik';
