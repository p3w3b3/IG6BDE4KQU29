      ...
      if (user) {
        ...
        let prereq = data['prereq'];
          ...
          let firstletter = name.substring(0, 1)
           ...
           let pizza1 = data['pizza2p1'];    
           let pizza2 = data['pizza2p2'];    
           let pizza3 = data['pizza2p3'];    
           let pizza4 = data['pizza2p4'];    
           let pizza5 = data['pizza2p5'];    
...
let course23 = data['pizzacourse3']
  ...
  firebase.firestore().doc("users/"+firebase.auth().currentUser.uid)
    .set({pizzacourse2total:spn}, {merge:true})
  }
  ...
  checkprog()
     ...
     if(!!name) {
      ...
      {
      setTimeout(() => { 
             window.location.href = '/dashboard/training/late-night-pizza';
